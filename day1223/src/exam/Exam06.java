...
//		단, bmi = 몸무게(kg)/키(m)의 제곱이며 bmi가 20.0 이상이고 25.0 미만이면 "표준체중입니다.",
...
//				홍길동님의 bmi는 15.9(22.9)이며 체중관리가 필요합니다(표준체중입니다).
		...
		if (bmi >= 20.0 && bmi < 25.0) 
			System.out.printf("%s님의 bmi는 %.1f이며 표준체중입니다.", name, bmi);
		else
			System.out.printf("%s님의 bmi는 %.1f이며 체중관리가 필요합니다.", name, bmi);
